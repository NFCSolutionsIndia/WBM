...
const TickerItem = ({ symbol, name }: { symbol: string; name: string }) => (
  <div className="flex items-center gap-3 mx-8 flex-shrink-0">
    <div
      className="w-10 h-10 rounded-xl flex items-center justify-center font-sans font-black text-sm"
...
export default function MetalTicker() {
  ...
  return (
    <section className="py-5 border-y border-[var(--c-border)] bg-[var(--c-bg2)] overflow-hidden relative">
      {/* Left fade */}
