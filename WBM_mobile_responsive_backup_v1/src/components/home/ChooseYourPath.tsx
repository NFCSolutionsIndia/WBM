      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-12 text-center max-w-2xl mx-auto">
          ...
          <ScrollReveal delay={0.1}>
            <h2
              className="font-sans font-black uppercase tracking-tighter text-[28px] md:section-title text-[var(--c-fg)] leading-[0.9] mb-6"
            >
        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 min-h-[500px]">
          ...
          <div className="w-full md:w-1/3 flex flex-wrap md:flex-col gap-3 justify-center md:justify-start mb-8 md:mb-0">
            {paths.map((path) => {
          ...
          <div className="w-full md:w-2/3">
            <TiltCard intensity={2} className="h-full w-full rounded-[var(--radius-card)]">
              <div className="glass h-full w-full rounded-[inherit] p-5 md:p-12 relative overflow-hidden flex flex-col">
