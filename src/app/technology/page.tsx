...
export default function TechnologyPage() {
  const sections = [
    { 
      heading: "Smart Systems for Material Separation", 
      subtext: "Automation meets precision.", 
      content: "Our facilities use intelligent sorting and processing systems to identify and separate materials efficiently, improving recovery rates and reducing waste." 
    },
    { 
      heading: "High-Purity Material Recovery", 
      subtext: "Advanced methods for maximum yield.", 
      content: "We use chemical and mechanical processes to extract valuable minerals such as lithium, cobalt, and gold from processed materials." 
    },
    { 
      heading: "Data-Driven Optimization", 
      subtext: "Improving efficiency through intelligence.", 
      content: "AI systems monitor and optimize operations in real time, ensuring consistent performance, reduced errors, and improved output quality." 
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] pb-24">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 mb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/WBM/media/BackgroundImgHero.png" alt="Technology WBM" fill className="object-cover opacity-60 dark:opacity-30" priority />
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto pt-24">
          ...
          >
            Innovative systems designed for efficiency, precision, and scalability.
          </motion.p>
        </div>
      </section>
