...
export default function TechnologySnapshot() {
  ...
  return (
    <section className="py-10 bg-[#080808] text-white overflow-hidden relative">
        ...
        <div className="w-full lg:w-1/2 lg:pr-20">
          <ScrollReveal>
            ...
            <button 
              ...
              className="px-8 py-4 border border-white/20 text-white font-bold uppercase tracking-widest text-sm rounded-full hover:bg-white hover:text-black transition-colors duration-300"
            >
              Inside the Plant
            </button>
          </ScrollReveal>
