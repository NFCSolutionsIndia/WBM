      ...
      <div className="max-w-5xl mx-auto px-6 text-center mb-16">
        ...
        >
          ...
          <h2 className="font-sans font-black uppercase tracking-tighter leading-[0.9] text-[clamp(36px,6vw,72px)] text-white mb-6">
            The Whole Story<br />
            <span className="text-[#839470]">In One Frame.</span>
          </h2>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
             <div className="px-6 py-3 rounded-full bg-[#839470] text-black font-sans font-black uppercase tracking-widest text-xs shadow-2xl">
