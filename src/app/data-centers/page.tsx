...
export default function DataCentersPage() {
  const sections = [
    { 
      heading: "High-Performance Facilities", 
      subtext: "Built for reliability.", 
      content: "Our data centers provide scalable, secure infrastructure for AI and enterprise applications." 
    },
    { 
      heading: "End-to-End Solutions", 
      subtext: "From hardware to recovery.", 
      content: "We offer server recycling, GPU recovery, and secure data destruction services." 
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] pb-24">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 mb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/WBM/media/BackgroundImgHero.png" alt="Data Centers WBM" fill className="object-cover opacity-60 dark:opacity-30" priority />
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto pt-24">
          ...
          >
            Powering data with responsible resource use.
          </motion.p>
        </div>
      </section>
