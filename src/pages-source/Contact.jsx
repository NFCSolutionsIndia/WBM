...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] transition-colors duration-500">
      ...
      {/* Main Content Area */}
      <section className="relative py-12 md:py-24 bg-[var(--c-bg)]">
                ...
                <form className="space-y-6 md:space-y-8" onSubmit={e => e.preventDefault()}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div className="space-y-3">
                      ...
                      <input type="text" placeholder="Organization" className="w-full bg-[var(--c-bg)] border border-[var(--c-border)] rounded-xl px-5 py-4 text-[var(--c-fg)] focus:outline-none focus:border-[var(--c-lime)] transition-all placeholder:text-[var(--c-fg)]/30 shadow-inner" />
                    </div>
                    <div className="space-y-3">
