...
export default function ReadyToCollaborate() {
  ...
  return (
    <section className="py-10 w-full bg-[var(--c-bg)] relative overflow-hidden" id="contact">
            ...
            <div className="glass shadow-[0_15px_40px_rgba(0,0,0,0.03)] rounded-[var(--radius-card)] p-8 border border-[var(--c-border)] h-full">
              <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["Invest", "Supply Feedstock", "Partner"].map((opt) => (
                      <button
                        ...
                        className={`flex-1 min-w-[120px] py-4 px-4 rounded-[12px] font-sans font-black text-xs uppercase tracking-widest transition-all duration-500 flex items-center justify-center border ${intent === opt
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-5 rounded-[12px] font-sans font-black text-sm uppercase tracking-[0.2em] text-black bg-[var(--c-highlight)] shadow-[0_20px_40px_rgba(131,148,112,0.2)] hover:shadow-[0_25px_50px_rgba(131,148,112,0.3)] transition-all duration-500"
                >
                  Initiate Connection
                </motion.button>
              </form>
