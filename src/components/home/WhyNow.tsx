      ...
      <div className="max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            ...
            <h2 className="text-3xl md:text-[52px] font-black uppercase tracking-tighter mb-6 leading-tight text-white">
            ...
            <button className="px-8 py-4 border border-[var(--c-lime)]/30 text-white font-bold uppercase tracking-widest text-sm rounded-full hover:bg-[var(--c-lime)] hover:text-black transition-all duration-300">
        ...
        <div className="w-full lg:w-1/2 relative h-[500px]">
          <motion.div
            ...
            className="w-full h-full relative rounded-[20px] overflow-hidden border border-white/10 shadow-[0_0_50px_rgba(193,255,0,0.1)]"
          >
            <Image
