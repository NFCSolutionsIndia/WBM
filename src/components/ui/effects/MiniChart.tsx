    ...
    <div className="w-full mt-2 opacity-60 group-hover:opacity-100 transition-opacity">
      <div className="flex justify-between items-center mb-4">
         <div className="flex flex-col">
            <span className="text-[7px] font-black text-white/30 uppercase tracking-widest mb-1">Latency</span>
            <span className="text-[10px] font-black text-[var(--c-highlight)] tracking-tighter">0.8ms</span>
         </div>
         <div className="flex flex-col text-right">
            <span className="text-[7px] font-black text-white/30 uppercase tracking-widest mb-1">Stability</span>
            <span className="text-[10px] font-black text-white">99.99%</span>
         </div>
      </div>
