...
const MergedPlanes = forwardRef<THREE.Mesh, MergedPlanesProps>(({ material, width, count, height }, ref): React.ReactNode => {
...
const PlaneNoise = forwardRef<THREE.Mesh, MergedPlanesProps>((props, ref): React.ReactNode => (
