...
import { Truck, Recycle, Trash2, Battery, Cpu, Magnet, ShieldCheck, Activity, ArrowRight, DollarSign, AlertCircle, Clock, Globe, Zap, BarChart3 } from 'lucide-react';
...
const ForYouSupplier = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] transition-colors duration-500 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button href="/contact" size="lg">Submit Feedstock Sample</Button>
              <Button href="/regulatory" variant="outline" size="lg">Download Criteria PDF</Button>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* Warning Banner */}
      <section className="py-12 bg-red-500/10 border-y border-red-500/20">
      ...
      <section className="py-24 bg-[var(--c-fg)]/5">
        <div className="max-w-7xl mx-auto px-6">
           <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8 text-left">
              ...
              <p className="text-lg text-[var(--c-fg2)] max-w-md">Streamlined logistics and instant revenue for your waste streams.</p>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((point, i) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.1 }}
                  className="p-8 rounded-[24px] bg-[var(--c-bg)] border border-[var(--c-border)] hover:border-[var(--c-lime)] transition-all"
                >
      ...
      <section className="py-24 bg-[var(--c-bg)] relative">
        <div className="max-w-7xl mx-auto px-6 text-center">
           <h2 className="text-sm font-black tracking-[0.3em] text-[var(--c-lime)] uppercase mb-16">Operational Metrics</h2>
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
              {stats.map((stat, i) => (
                <motion.div 
                  ...
                  viewport={{ once: true }}
                >
                   <div className="text-6xl md:text-7xl font-black text-[var(--c-fg)] tracking-tighter mb-4 leading-none group-hover:text-[var(--c-lime)]">
                       <span className="text-[var(--c-lime)]">{(stat.value === 0 || stat.value === "0" || !stat.value) ? "--" : stat.value}</span>{(stat.value === 0 || stat.value === "0" || !stat.value) ? "" : stat.suffix}
                   </div>
      ...
      <section className="py-24 bg-[var(--c-fg)] text-[var(--c-bg)] text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="section-title font-black tracking-tighter mb-10 leading-none uppercase">Ready to Convert <br /> <span className="text-[var(--c-lime)]">Waste into Revenue?</span></h2>
            <p className="text-xl opacity-60 font-medium mb-12 max-w-2xl mx-auto">Get a routing decision within 48 hours of sample submission. Join the world's most integrated recovery network.</p>
            <div className="flex flex-wrap justify-center gap-4">
