...
import { ShieldCheck, Cpu, Zap, Activity, Award, FlaskConical, Globe, ArrowRight, Layers, Database, Lock, Search, Filter, ChevronRight, BarChart3, LineChart as LineChartIcon } from 'lucide-react';
...
const ForYouCustomer = () => {
  ...
  return (
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] transition-colors duration-500 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-[64px] font-black text-white leading-[0.9] tracking-tighter mb-8 uppercase">
               Supply <span className="text-[var(--c-highlight)] lime-glow-text">Secured.</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button href="/customer/offtake-request" size="lg">Request Off-take MOU</Button>
        ...
        <div className="max-w-7xl mx-auto px-6">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <motion.div 
                ...
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
                className="order-2 lg:order-1 p-10 rounded-[32px] border border-[var(--c-border)] bg-[var(--c-bg2)] relative overflow-hidden"
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-baseline gap-2 mb-1">
                      <span className="text-3xl font-black text-[var(--c-fg)] group-hover:text-[var(--c-lime)] transition-colors">{(stat.value === 0 || stat.value === "0" || !stat.value) ? "--" : stat.value}</span>
                       ...
                       {filteredMinerals.map((m, i) => (
                         ...
                         >
                            ...
                            <td className="p-6 text-right">
                               <Button size="sm" variant="outline" href="/contact">Request Spec</Button>
                            </td>
                         </motion.tr>
                       ))}
                    </AnimatePresence>
           ...
           <div className="lg:hidden space-y-4">
              {filteredMinerals.map((m, i) => (
                ...
                >
                   ...
                   <Button className="w-full text-center" href="/contact">Request Spec</Button>
                </motion.div>
              ))}
           </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-[var(--c-bg)] text-center border-t border-[var(--c-border)] relative">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-xl text-[var(--c-fg2)] font-medium mb-12 max-w-2xl mx-auto">One signature away from engineering-grade reclaimed minerals. Start the off-take MOU process today.</p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button href="/customer/offtake-request" size="lg">Request Off-take MOU</Button>
            </div>
          </motion.div>
