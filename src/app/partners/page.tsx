...
export default function PartnersPage() {
  const sections = [
    { 
      ...
      subtext: "Reliable and scalable.", 
      content: "Partnering with us ensures access to sustainable materials and advanced processing capabilities." 
    },
    { 
      heading: "Multiple Collaboration Models", 
      subtext: "Flexible engagement.", 
      content: "We work with industrial partners, investors, and suppliers to build long-term value." 
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] pb-24">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 mb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/WBM/media/outsideWarehouse1.png" alt="Partners WBM" fill className="object-cover opacity-60 dark:opacity-30" priority />
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto pt-24">
          ...
          >
            Building sustainable supply chains together.
          </motion.p>
        </div>
      </section>
