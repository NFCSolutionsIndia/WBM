        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <ScrollReveal key={card.title} delay={i * 0.1}>
              <TiltCard
                className="group relative p-10 rounded-[24px] bg-[#111419] border border-white/20 backdrop-blur-xl h-full overflow-hidden"
              ...
              >
                ...
                <div className="flex justify-between items-start mb-12">
                   ...
                   <div className="text-right">
                      ...
                      <div className="flex items-center gap-1.5 justify-end">
                         ...
                         <span className="text-[8px] font-bold text-white/40 uppercase tracking-widest">{card.status}</span>
                      </div>
                   </div>
                </div>
                ...
                <div className="relative z-10">
                   ...
                   <h4 className="text-2xl font-black text-white uppercase tracking-tighter mb-4 group-hover:text-[var(--c-highlight)] transition-colors">{card.label}</h4>
