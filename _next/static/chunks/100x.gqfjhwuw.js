(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,48256,e=>{"use strict";let t=(0,e.i(75254).default)("globe",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20",key:"13o1zl"}],["path",{d:"M2 12h20",key:"9i4pu4"}]]);e.s(["Globe",0,t],48256)},57303,e=>{"use strict";var t=e.i(43476),i=e.i(33623),r=e.i(71645),s=e.i(90072),o=e.i(8560);let a={onSpeedUp:()=>{},onSlowDown:()=>{},distortion:"turbulentDistortion",length:400,roadWidth:10,islandWidth:2,lanesPerRoad:4,fov:90,fovSpeedUp:150,speedUp:2,carLightsFade:.4,totalSideLightSticks:20,lightPairsPerRoadWay:40,shoulderLinesWidthPercentage:.05,brokenLinesWidthPercentage:.1,brokenLinesLengthPercentage:.5,lightStickWidth:[.12,.5],lightStickHeight:[1.3,1.7],movingAwaySpeed:[60,80],movingCloserSpeed:[-120,-160],carLightsLength:[12,80],carLightsRadius:[.05,.14],carWidthPercentage:[.3,.5],carShiftX:[-.8,.8],carFloorSeparation:[0,5],colors:{roadColor:526344,islandColor:657930,background:0,shoulderLines:0xffffff,brokenLines:0xffffff,leftCars:[0xd856bf,6770850,0xc247ac],rightCars:[242627,941733,3294549],sticks:242627}};e.s(["default",0,({effectOptions:e,speed:n,color:l})=>{let c=(0,r.useRef)(null),h=(0,r.useRef)(null);return(0,r.useEffect)(()=>{if(h.current){h.current.dispose(),h.current=null;let e=c.current;if(e)for(;e.firstChild;)e.removeChild(e.firstChild)}let t={uFreq:{value:new s.Vector3(3,6,10)},uAmp:{value:new s.Vector3(30,30,20)}},r={uFreq:{value:new s.Vector2(5,2)},uAmp:{value:new s.Vector2(25,15)}},d={uFreq:{value:new s.Vector2(2,3)},uAmp:{value:new s.Vector2(35,10)}},u={uFreq:{value:new s.Vector4(4,8,8,1)},uAmp:{value:new s.Vector4(25,5,10,10)}},m={uFreq:{value:new s.Vector2(4,8)},uAmp:{value:new s.Vector2(10,20)},uPowY:{value:new s.Vector2(20,2)}},p=e=>.5*Math.sin(e)+.5,g={mountainDistortion:{uniforms:t,getDistortion:`
          uniform vec3 uAmp;
          uniform vec3 uFreq;
    ...
    `,x=e=>Array.isArray(e)?Math.random()*(e[1]-e[0])+e[0]:Math.random()*e,w=e=>Array.isArray(e)?e[Math.floor(Math.random()*e.length)]:e;function b(e,t,i=.1,r=.001){let s=(t-e)*i;return Math.abs(s)<r&&(s=t-e),s}class y{webgl;options;colors;speed;fade;mesh=null;constructor(e,t,i,r,s){this.webgl=e,this.options=t,this.colors=i,this.speed=r,this.fade=s}init(){let e=this.options,t=new s.LineCurve3(new s.Vector3(0,0,0),new s.Vector3(0,0,-1)),i=new s.TubeGeometry(t,40,1,8,!1),r=new s.InstancedBufferGeometry().copy(i);r.instanceCount=2*e.lightPairsPerRoadWay;let o=e.roadWidth/e.lanesPerRoad,a=[],n=[],l=[],c=this.colors;c=Array.isArray(c)?c.map(e=>new s.Color(e)):new s.Color(c);for(let t=0;t<e.lightPairsPerRoadWay;t++){let i=x(e.carLightsRadius),r=x(e.carLightsLength),s=x(this.speed),h=t%e.lanesPerRoad*o-e.roadWidth/2+o/2,d=x(e.carWidthPercentage)*o;h+=x(e.carShiftX)*o;let u=x(e.carFloorSeparation)+1.3*i,m=-x(e.length);a.push(h-d/2),a.push(u),a.push(m),a.push(h+d/2),a.push(u),a.push(m),n.push(i),n.push(r),n.push(s),n.push(i),n.push(r),n.push(s);let p=w(c);l.push(p.r),l.push(p.g),l.push(p.b),l.push(p.r),l.push(p.g),l.push(p.b)}r.setAttribute("aOffset",new s.InstancedBufferAttribute(new Float32Array(a),3,!1)),r.setAttribute("aMetrics",new s.InstancedBufferAttribute(new Float32Array(n),3,!1)),r.setAttribute("aColor",new s.InstancedBufferAttribute(new Float32Array(l),3,!1));let h=new s.ShaderMaterial({fragmentShader:P,vertexShader:k,transparent:!0,uniforms:Object.assign({uTime:{value:0},uTravelLength:{value:e.length},uFade:{value:this.fade}},this.webgl.fogUniforms,e.distortion.uniforms)});h.onBeforeCompile=t=>{t.vertexShader=t.vertexShader.replace("#include <getDistortion_vertex>",e.distortion.getDistortion)};let d=new s.Mesh(r,h);d.frustumCulled=!1,this.webgl.scene.add(d),this.mesh=d}update(e){this.mesh&&(this.mesh.material.uniforms.uTime.value=e)}}let P=`
      #define USE_FOG;
    ...
    `,N=C.replace("#include <roadMarkings_fragment>",T).replace("#include <roadMarkings_vars>",F),D=`
      #define USE_FOG;
      uniform float uTime;
      ${o.ShaderChunk.fog_pars_vertex}
      uniform float uTravelLength;
