...
export default function IndustriesPage() {
  const sections = [
    { 
      heading: "Powering the EV Revolution", 
      subtext: "Battery-grade materials for mobility.", 
      content: "We provide essential materials such as lithium and cobalt used in EV battery production." 
    },
    { 
      heading: "Supporting Digital Infrastructure", 
      subtext: "Materials for high-performance systems.", 
      content: "Our recovered metals support servers, storage systems, and connectivity infrastructure." 
    },
    { 
      heading: "Advanced Material Supply", 
      subtext: "Precision and reliability.", 
      content: "We supply rare earth materials critical for high-performance aerospace and defense applications." 
    },
    { 
      heading: "Sustainable Manufacturing", 
      subtext: "Materials for modern devices.", 
      content: "Recovered metals are used in smartphones, laptops, and consumer electronics production." 
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] pb-24">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 mb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/WBM/media/Industies.jpg" alt="Industries WBM" fill className="object-cover opacity-60 dark:opacity-30" priority />
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto pt-24">
          ...
          >
            Supplying critical materials for global innovation.
          </motion.p>
        </div>
      </section>
