...
const numbers = [
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><path d="M4 14a8 8 0 0 1 15-3"/><path d="M19 11v3h-3"/><path d="M20 10a8 8 0 0 0-15 3"/><path d="M5 13v-3h3"/></svg>, value: "98.7%",      title: "AI Accuracy Rate",       desc: "Material identification precision across every waste stream",   accent: "#78B933" },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="8" y1="12" x2="8" y2="17"/><line x1="12" y1="10" x2="12" y2="17"/><line x1="16" y1="14" x2="16" y2="17"/></svg>, value: "50k T/YR", title: "Plant Capacity",          desc: "Annual processing throughput at full operational capacity",   accent: "#78B933" },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg>,                                                                                                                                                                   value: "99.9%",      title: "Mineral Purity",         desc: "Industry-grade output quality certified for immediate use",    accent: "#78B933" },
  ...
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>,                                                                                                                                        value: "24/7",       title: "Operational Hours",      desc: "Continuous AI-monitored operation with zero downtime targets",  accent: "#78B933" },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M8 8h8v8H8z"/></svg>,                                                                                                                                    value: "48",         title: "Robotic Arms",           desc: "AI-guided robotic sorting systems operating in unison",         accent: "#78B933" },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>,                                                                                                                      value: "3.4×",       title: "Annual Revenue Growth",  desc: "Year-over-year expansion across all revenue streams",           accent: "#78B933" },
  { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,                                                                                                                                                   value: "12,000+",    title: "Carbon Credits/yr",      desc: "Certified emissions offsets generated annually",                accent: "#78B933" },
];
...
export default function NumbersThatSpeak() {
  return (
    <section className="relative bg-[#080808] min-h-screen">
      ...
      {/* Two-column content */}
      <div className="relative z-10 flex flex-col lg:flex-row w-full max-w-7xl mx-auto px-6 gap-12 py-12">
        ...
        <div className="w-full lg:w-5/12 lg:pr-8 flex-shrink-0 lg:sticky lg:top-32 h-fit">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-px bg-[#78B933]" />
              <span className="font-sans font-bold text-xs uppercase tracking-[0.3em] text-[#78B933]">
                Performance Metrics
              </span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {numbers.map((num, i) => (
              <motion.div
                ...
                className="group relative rounded-[20px] bg-black/60 backdrop-blur-xl border border-white/10 p-6 md:p-8 overflow-hidden transition-all duration-500 hover:border-[#78B933]/50 hover:shadow-[0_10px_40px_rgba(178,197,130,0.1)]"
              >
