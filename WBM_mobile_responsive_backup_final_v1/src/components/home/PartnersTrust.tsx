      ...
      <div className="max-w-7xl mx-auto px-6 text-center mb-12 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-6 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm">
            <span className="font-sans font-bold text-xs uppercase tracking-[0.25em] text-[#839470]">Strategic Partnerships</span>
          </div>
          <h2 className="section-title font-black uppercase tracking-tighter text-white mb-6">
            Built with Industry <span className="text-[#839470]">Leaders</span>
          </h2>
          ...
          <button className="px-8 py-4 bg-[#839470] text-black font-bold uppercase tracking-widest text-sm rounded-full hover:bg-white transition-colors duration-300 shadow-[0_0_20px_rgba(193,255,0,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]">
            Become a Partner
          </button>
        </motion.div>
      </div>
        ...
        >
          ...
          {[...partners, ...partners, ...partners, ...partners].map((partner, i) => (
            ...
            >
              ...
              <span className="mt-2 text-xs font-bold uppercase tracking-widest text-[#839470]/60 group-hover/card:text-[#839470] transition-colors duration-300">
                {partner.tag}
              </span>
            </motion.div>
          ))}
