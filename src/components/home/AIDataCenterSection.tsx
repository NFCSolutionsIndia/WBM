...
export default function AIDataCenterSection() {
  ...
  return (
    <section id="ai-data-centre" className="py-24 bg-[#F9FAFB] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          
          <div className="w-full lg:w-1/2">
            <div className="inline-block px-4 py-1.5 rounded-full border border-[#00D4FF]/30 bg-[#00D4FF]/10 text-[#00D4FF] font-medium text-sm mb-6 pb-2">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, idx) => (
                ...
                >
                  <div className="shrink-0 pt-1 text-[#00D4FF]">
                    {feature.icon}
                  </div>
                  <div>
          ...
          <div className="w-full lg:w-1/2 h-[500px] relative">
            <motion.div 
              ...
              className="absolute inset-0 bg-gradient-to-tr from-[#111827] to-[#1E6091] rounded-3xl overflow-hidden shadow-2xl"
            >
