...
`;e.s(["default",0,({variant:e="square",pixelSize:o=3,color:d="#B497CF",className:m,style:x,antialias:u=!0,patternScale:f=2,patternDensity:p=1,liquid:h=!1,liquidStrength:g=.1,liquidRadius:b=1,pixelSizeJitter:y=0,enableRipples:w=!0,rippleIntensityScale:j=1,rippleThickness:k=.1,rippleSpeed:N=.3,liquidWobbleSpeed:C=4.5,autoPauseOffscreen:S=!0,speed:E=.5,transparent:R=!0,edgeFade:M=.5,noiseAmount:z=0})=>{let T=(0,r.useRef)(null),P=(0,r.useRef)({visible:!0}),A=(0,r.useRef)(E),I=(0,r.useRef)(null),L=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let e=T.current;if(!e)return;let t=new IntersectionObserver(([e])=>{P.current.visible=e.isIntersecting},{threshold:.01});return t.observe(e),()=>t.disconnect()},[]),(0,r.useEffect)(()=>{let t=T.current;if(!t)return;A.current=E;let r={antialias:u,liquid:h,noiseAmount:z},m=!1;if(I.current){if(L.current){for(let e of["antialias","liquid","noiseAmount"])if(L.current[e]!==r[e]){m=!0;break}}}else m=!0;if(m){let r,m,E;if(I.current){let e=I.current;e.resizeObserver?.disconnect(),cancelAnimationFrame(e.raf),e.quad?.geometry.dispose(),e.material.dispose(),e.composer?.dispose(),e.renderer.dispose(),e.renderer.forceContextLoss(),e.renderer.domElement.parentElement===t&&t.removeChild(e.renderer.domElement),I.current=null}let T=document.createElement("canvas"),L=new s.WebGLRenderer({canvas:T,antialias:u,alpha:!0,powerPreference:"high-performance"});L.domElement.style.width="100%",L.domElement.style.height="100%",L.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.appendChild(L.domElement),R?L.setClearAlpha(0):L.setClearColor(0,1);let q={uResolution:{value:new i.Vector2(0,0)},uTime:{value:0},uColor:{value:new i.Color(d)},uClickPos:{value:Array.from({length:10},()=>new i.Vector2(-1,-1))},uClickTimes:{value:new Float32Array(10)},uShapeType:{value:l[e]??0},uPixelSize:{value:o*L.getPixelRatio()},uScale:{value:f},uDensity:{value:p},uPixelJitter:{value:y},uEnableRipples:{value:+!!w},uRippleSpeed:{value:N},uRippleThickness:{value:k},uRippleIntensity:{value:j},uEdgeFade:{value:M}},F=new i.Scene,V=new i.OrthographicCamera(-1,1,1,-1,0,1),D=new i.ShaderMaterial({vertexShader:c,fragmentShader:n,uniforms:q,transparent:!0,depthTest:!1,depthWrite:!1,glslVersion:i.GLSL3}),_=new i.PlaneGeometry(2,2),O=new i.Mesh(_,D);F.add(O);let U=new i.Clock,H=()=>{let e=t.clientWidth||1,a=t.clientHeight||1;L.setSize(e,a,!1),q.uResolution.value.set(L.domElement.width,L.domElement.height),I.current?.composer&&I.current.composer.setSize(L.domElement.width,L.domElement.height),q.uPixelSize.value=o*L.getPixelRatio()};H();let W=new ResizeObserver(H);W.observe(t);let G=1e3*(()=>{if(window.crypto?.getRandomValues){let e=new Uint32Array(1);return window.crypto.getRandomValues(e),e[0]/0xffffffff}return Math.random()})();if(h){var x,B;let e;(m=(()=>{let e=document.createElement("canvas");e.width=64,e.height=64;let t=e.getContext("2d");if(!t)throw Error("2D context not available");t.fillStyle="black",t.fillRect(0,0,e.width,e.height);let a=new i.Texture(e);a.minFilter=i.LinearFilter,a.magFilter=i.LinearFilter,a.generateMipmaps=!1;let r=[],s=null,l=6.4,c=e=>{let a={x:64*e.x,y:(1-e.y)*64},r=1;if(e.age<19.2)r=Math.sin(e.age/19.2*Math.PI/2);else{let t;r=-(t=1-(e.age-19.2)/44.8)*(t-2)||0}r*=e.force;let i=`${(e.vx+1)/2*255}, ${(e.vy+1)/2*255}, ${255*r}`;t.shadowOffsetX=320,t.shadowOffsetY=320,t.shadowBlur=l,t.shadowColor=`rgba(${i},${.22*r})`,t.beginPath(),t.fillStyle=`rgba(${i},${r})`,t.arc(a.x-320,a.y-320,l,0,2*Math.PI),t.fill()};return{canvas:e,texture:a,addTouch:e=>{let t=0,a=0,i=0;if(s){let r=e.x-s.x,l=e.y-s.y;if(0===r&&0===l)return;let c=r*r+l*l,n=Math.sqrt(c);a=r/(n||1),i=l/(n||1),t=Math.min(1e4*c,1)}s={x:e.x,y:e.y},r.push({x:e.x,y:e.y,age:0,force:t,vx:a,vy:i})},update:()=>{t.fillStyle="black",t.fillRect(0,0,e.width,e.height);for(let e=r.length-1;e>=0;e--){let t=r[e],a=.015625*t.force*(1-t.age/64);t.x+=t.vx*a,t.y+=t.vy*a,t.age++,t.age>64&&r.splice(e,1)}for(let e=0;e<r.length;e++)c(r[e]);a.needsUpdate=!0},set radiusScale(v){l=6.4*v},get radiusScale(){return l/6.4},size:64}})()).radiusScale=b,r=new a.EffectComposer(L);let t=new a.RenderPass(F,V);x=m.texture,B={strength:g,freq:C},e=`
