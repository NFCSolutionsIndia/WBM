...
export default function MaterialsPage() {
  const sections = [
    { 
      heading: "High-Value Conductive Materials", 
      subtext: "Essential for electronics.", 
      content: "Gold, silver, and copper are recovered and refined for use in circuitry and connectors." 
    },
    { 
      heading: "Energy Storage Components", 
      subtext: "Powering modern energy systems.", 
      content: "Lithium, cobalt, and nickel are extracted and supplied for battery manufacturing." 
    },
    { 
      heading: "Specialized Industrial Materials", 
      subtext: "Driving advanced technologies.", 
      content: "Rare earth elements are used in magnets, motors, and high-tech applications." 
    }
  ];
    ...
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] pb-24">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 mb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/WBM/media/DistributionProcess.png" alt="Materials WBM" fill className="object-cover opacity-60 dark:opacity-30" priority />
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto pt-24">
          ...
          >
            High-quality resources for industrial applications.
          </motion.p>
        </div>
      </section>
