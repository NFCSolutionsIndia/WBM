        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-2 gap-10">
                <div>
                  ...
                  <p className="text-gray-400 font-medium text-sm">Revenue invested in R&D annually</p>
                </div>
                <div>
                  <div className="text-5xl font-bold text-white mb-2 tracking-tighter">42</div>
                  <p className="text-gray-400 font-medium text-sm">Active patents in material recovery</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 relative">
               ...
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] bg-[var(--c-lime)]/10 rounded-full blur-[120px] pointer-events-none"></div>
            </div>
          </div>
        </div>
      </section>
