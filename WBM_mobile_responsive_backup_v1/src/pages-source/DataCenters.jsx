...
const DataCenters = () => {
  return (
    <div className="min-h-screen bg-[var(--c-bg)] text-[var(--c-fg)] transition-colors duration-500">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-black pt-20 pb-12 md:pt-40 md:pb-32 transition-colors duration-500">
      ...
      <section className="py-6 bg-[var(--c-bg)] relative overflow-hidden transition-colors duration-500">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="relative pt-10">
            <div className="flex flex-col items-center mb-8 lg:absolute lg:top-0 lg:left-1/2 lg:-translate-x-1/2 lg:mb-0">
               ...
               <div className="w-px h-8 bg-gradient-to-b from-[var(--c-lime)] to-transparent mt-4" />
            </div>
                 ...
                 >
                   ...
                   <div className="space-y-3">
                      <div className="flex justify-between items-end">
                         ...
                         <div className="text-sm font-black" style={{ color: cat.color }}>{(cat.coverage === 0 || cat.coverage === "0" || !cat.coverage) ? "--" : `${cat.coverage}%`}</div>
                      </div>
      ...
      {/* Security Section */}
      <section className="py-8 md:py-24 bg-[var(--c-fg)]/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
            ...
            >
              <h2 className="section-title section-title  font-bold text-[var(--c-fg)] leading-tight tracking-tight mb-6 md:mb-10">
      ...
      {/* CTA */}
      <section className="py-8 bg-[var(--c-bg)] text-center transition-colors duration-300">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="section-title font-bold text-[var(--c-fg)] tracking-tight mb-6 leading-tight">Ready to decommission your <span className="text-[var(--c-lime)]">retired hardware?</span></h2>
            <p className="text-xl md:text-2xl text-gray-500 dark:text-gray-400 font-medium mb-8 leading-relaxed max-w-3xl mx-auto">Our infrastructure team provides specialized solutions for enterprise data centers and AI clusters.</p>
