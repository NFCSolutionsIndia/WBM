        ...
        <div className="relative border-l-2 border-white/10 ml-6 md:ml-0 md:border-l-0">
          ...
          {steps.map((step, i) => (
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
              className={\`relative mb-16 md:w-1/2 \${i % 2 === 0 ? 'md:pr-16 md:ml-0' : 'md:pl-16 md:ml-auto'} pl-8 md:pl-0\`}
            >
              {/* Dot */}
              <div className={\`absolute top-2 w-4 h-4 rounded-full bg-[#C1FF00] \${i % 2 === 0 ? 'md:-right-2' : 'md:-left-2'} -left-[25px] md:left-auto border-4 border-[#0d1a14] z-10\`} />
    ...
    <div className="min-h-screen bg-[#0d1a14] text-white pt-32 pb-24">
      ...
      <section className="px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="text-white/20 font-mono text-4xl font-bold">DATA FLOW</div>
        </motion.div>
      </section>
    </div>
  );
      ...
      <section className="px-6 max-w-2xl mx-auto">
        ...
        >
          <div className="grid gap-2">
            ...
            <input type="text" className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#C1FF00] transition-colors" />
          </div>
          <div className="grid gap-2">
            <label className="text-sm text-gray-400 ml-1">Email</label>
            <input type="email" className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#C1FF00] transition-colors" />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <textarea rows={4} className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#C1FF00] transition-colors resize-none" />
          </div>
...
Object.entries(pages).forEach(([route, content]) => {
